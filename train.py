...
def main(args):
    ...
    if args.pretrain:
        model.load_state_dict(torch.load(os.path.join(args.pretrain_folder, args.pretrain + '.th'), map_location=torch.device('cpu')))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--transformer_model',
                        ...
                        help='batch_groupName of the transformer model.',
                        default='roberta')
