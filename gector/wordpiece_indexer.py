...
class WordpieceIndexer(TokenIndexer[int]):
    ...
    If you are using one of the pretrained BERT model, you'll want to use the ``PretrainedBertIndexer``
    ...
    def count_vocab_items(self, token: Token, counter: Dict[str, Dict[str, int]]):
        # If we only use pretrained model, we don't need to do anything here.
        pass
...
class PretrainedBertIndexer(WordpieceIndexer):
    ...
    pretrained_model: ``str``
        ...
        If the name is a key in the list of pretrained model at
